      ...
      <div className="max-w-screen-xl">
        <div className="flex justify-between items-center py-4 gap-10 mx-4 xl:mx-6">
          ...
          <div>
            <Link href="/#">
              <svg
                className="absolute ml-[87.5px] mt-[6px] rotate-[-20deg]"
                width="4"
                height="7"
                viewBox="0 0 5 7"
                fill="none"
              ...
              >
                <path
                  d="M1.83711 6.30726C2.83613 6.4344 3.80546 5.12591 3.99834 3.38834C4.19122 1.64546 3.53841 0.135674 2.53445 0.0085342C1.53543 -0.118606 0.566091 1.18988 0.373212 2.92745C0.180333 4.67033 0.833157 6.18012 1.83711 6.30726Z"
                  fill="#103559"
                />
              </svg>
              <svg
                className="absolute ml-[92.6px] mt-[4px] rotate-[3deg]"
                width="8"
                height="8"
                viewBox="0 0 5 7"
                fill="none"
              ...
              <svg
                className="absolute ml-[100px] mt-[7px] rotate-[24deg]"
                width="5"
                height="7"
                viewBox="0 0 5 7"
                fill="none"
              ...
              <svg
                className="absolute ml-[103.5px] mt-[12px] rotate-[45deg]"
                width="4"
                height="7"
                viewBox="0 0 5 7"
                fill="none"
