      ...
      <div className="md:px-10 lg:px-8 xl:px-[130px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row sm:p-4 border rounded-lg">
          ...
          <div className="md:w-1/2 md:pl-8 p-4">
            <div className="flex items-center gap-2 text-zinc-500 text-sm py-2 sm:p-0">
              Home{" "}
              <svg
                width="5"
                height="8"
